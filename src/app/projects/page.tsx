  ...
  return (
    <div>
      ...
      <div className="flex gap-x-4 gap-y-8 flex-wrap justify-center">
        ...
        <AllProjectsEntry title="Thesis prototype" blurb="Generating game story with ChatGPT" tags={['thesis']} imagePath="/thesis prototype banner.png" imageAlt="Thesis prototype banner" hrefPath="https://github.com/necrosmash/thesis_prototype" />
      </div>
    </div>
  )
}